...
def verify_task1_1():
    ...
    for expected_file in ["task1.csv"]:
        if os.path.isfile(expected_file):
            print(f"\tTask 1.1's {expected_file} output found.\n")
            if os.path.getsize(expected_file) == 0:
                print(f"\t❗ Task 1.1's {expected_file} output has size zero - please verify it uploaded correctly.\n")
        else:
            print(f"\t❗ Task 1.1's {expected_file} output NOT found. Please check your code.\n")
...
def verify_task1_2():
    ...
    for expected_file in ["task1_heatmap.png", "task1_pie.png"]:
        if os.path.isfile(expected_file):
